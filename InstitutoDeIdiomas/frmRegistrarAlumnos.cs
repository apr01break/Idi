...
namespace InstitutoDeIdiomas
{
    public partial class frmRegistrarAlumnos : MaterialForm
    {
        ...
        public void cargarCiclos()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("listar_ciclos", _SqlConnection);
                ...
                da.Fill(dt);
                CBCICLO.DisplayMember = "nomCiclo";
            ...
            if (VALIDAR_NO_VACIOS()) {                                                  
                ...
                //{                            
                    ...
                    if (PANELFAUSTINO.Visible == true)
                    {
                        ...
                        String CICLO= ((DataRowView)CBCICLO.SelectedItem)["idCiclo"].ToString();
                        comando.Parameters.Add(new SqlParameter("@facultad", FACULTAD));
                        comando.Parameters.Add(new SqlParameter("@escuela", ESCUELA));
                        comando.Parameters.Add(new SqlParameter("@ciclo", CICLO));
                    }
